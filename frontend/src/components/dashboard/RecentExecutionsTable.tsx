...
import { ArrowRight, GitCommit, FileText } from 'lucide-react';
                ...
                <div className="flex items-center gap-3.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.2 rounded-full border ${style.bg} ${style.text} ${style.border}`}>
                        <span className={`w-1 h-1 rounded-full ${style.dot}`} />
                        {style.label}
                      </span>
                    </div>
                    <p className="text-xs text-slate-300 truncate mt-0.5 group-hover:text-brand-300 transition-colors">
