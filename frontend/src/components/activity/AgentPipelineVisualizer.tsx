          ...
          return (
            <div key={step.id} className="relative flex items-start gap-3">
              ...
              <div
                className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 border z-10 transition-all ${
                  state === 'completed'
                    ...
                    : state === 'active'
                    ? 'bg-indigo-500/20 border-indigo-500/50 text-indigo-300 ring-2 ring-indigo-500/30 animate-pulse'
                    : state === 'skipped'
              ...
              <div
                className={`flex-1 p-3 rounded-xl border transition-all ${
                  state === 'completed'
                    ...
                    : state === 'active'
                    ? 'bg-indigo-950/30 border-indigo-500/40 text-indigo-200 ring-1 ring-indigo-500/20'
                    : state === 'skipped'
              ...
              >
                ...
                <p className="text-[11px] text-slate-300 font-medium">{step.desc}</p>
                <p className="text-[10px] text-slate-500 mt-1 font-mono truncate">{step.detail}</p>
              </div>
            </div>
          );
        })}
