...
export const ExecutionDetailDrawer: React.FC<ExecutionDetailDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-3 sm:p-5 md:p-6 lg:p-8 bg-black/80 backdrop-blur-md transition-all duration-200">
      ...
      <div className="relative w-full max-w-7xl h-[92vh] max-h-[920px] bg-dark-card border border-dark-border rounded-2xl shadow-2xl flex flex-col z-10 overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-10 min-h-0 overflow-hidden">
          ...
          {/* ========================================================================= */}
          <div className="lg:col-span-7 flex flex-col h-full min-h-0 overflow-hidden border-b lg:border-b-0 lg:border-r border-dark-border bg-dark-card">
            
            {/* 70% Header: Badges, Title, Metadata */}
            <div className="p-5 sm:p-6 border-b border-dark-border bg-slate-900/80 backdrop-blur-md shrink-0">
              ...
              <div className="flex flex-wrap items-center gap-3.5 text-xs font-mono text-slate-400 mt-2.5">
            ...
            {/* Navigation Tabs */}
            <div className="flex items-center gap-1 px-4 sm:px-6 border-b border-dark-border bg-slate-900/40 shrink-0 overflow-x-auto">
              {[
          ...
          {/* ========================================================================= */}
          <div className="lg:col-span-3 flex flex-col h-full min-h-0 bg-slate-950/80 p-5 sm:p-6 overflow-y-auto border-t lg:border-t-0 border-dark-border justify-between space-y-6">
            
            <div className="space-y-5">
              {/* Right Column Header: Title, Live Status & Close X */}
              <div className="flex items-center justify-between pb-3 border-b border-dark-border/80">
              ...
              <div className="flex items-center justify-between px-3.5 py-2 rounded-xl bg-slate-900/80 border border-dark-border">
            ...
            <div className="p-4 rounded-xl bg-slate-900/70 border border-dark-border space-y-2.5">
              <div className="flex items-center justify-between">
              ...
              <div className="space-y-1.5 text-xs text-slate-300">
                <div className="flex items-center justify-between text-[11px]">
                  ...
                  <span className="font-mono text-slate-200">gemini-3.5-flash-lite</span>
                </div>
                <div className="flex items-center justify-between text-[11px]">
                  <span className="text-slate-400">Engine Mode:</span>
                  <span className="font-mono text-emerald-400">Zero-Token Bot Bypass</span>
                </div>
                <div className="flex items-center justify-between text-[11px]">
                  <span className="text-slate-400">Docs Synchronized:</span>
                  <span className="font-mono text-slate-200">{execution.updated_documents?.length || 0} files</span>
                </div>
              </div>
            </div>
